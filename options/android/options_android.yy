{
  ...
  "option_android_icon_adaptivebg_hdpi":"${options_dir}/android/icons/hdpi.png",
  "option_android_icon_adaptivebg_ldpi":"${options_dir}/android/icons/ldpi.png",
  "option_android_icon_adaptivebg_mdpi":"${options_dir}/android/icons/mdpi.png",
  "option_android_icon_adaptivebg_xhdpi":"${options_dir}/android/icons/xhdpi.png",
  "option_android_icon_adaptivebg_xxhdpi":"${options_dir}/android/icons/xxhdpi.png",
  "option_android_icon_adaptivebg_xxxhdpi":"${options_dir}/android/icons/xxxhdpi.png",
  "option_android_icon_adaptive_generate":true,
  "option_android_icon_adaptive_hdpi":"${options_dir}/android/icons/hdpi.png",
  "option_android_icon_adaptive_ldpi":"${options_dir}/android/icons/ldpi.png",
  "option_android_icon_adaptive_mdpi":"${options_dir}/android/icons/mdpi.png",
  "option_android_icon_adaptive_xhdpi":"${options_dir}/android/icons/xhdpi.png",
  "option_android_icon_adaptive_xxhdpi":"${options_dir}/android/icons/xxhdpi.png",
  "option_android_icon_adaptive_xxxhdpi":"${options_dir}/android/icons/xxxhdpi.png",
