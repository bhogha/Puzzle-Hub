...
/// Hardcoded fallback (a validated 6×6, 6-flow board) when the data file is missing.
function ph_colorlink_fallback() {
    var _raw = {
        size: 6,
        flows: [
            { color: 0, a: [2,5], b: [3,4], path: [[2,5],[3,5],[4,5],[5,5],[5,4],[4,4],[3,4]] },
            { color: 1, a: [2,4], b: [3,3], path: [[2,4],[2,3],[3,3]] },
            { color: 2, a: [4,3], b: [3,2], path: [[4,3],[5,3],[5,2],[5,1],[5,0],[4,0],[4,1],[4,2],[3,2]] },
            { color: 3, a: [3,1], b: [1,0], path: [[3,1],[3,0],[2,0],[1,0]] },
            { color: 4, a: [0,0], b: [0,2], path: [[0,0],[0,1],[1,1],[2,1],[2,2],[1,2],[0,2]] },
            { color: 5, a: [0,3], b: [1,5], path: [[0,3],[1,3],[1,4],[0,4],[0,5],[1,5]] },
        ],
    };
