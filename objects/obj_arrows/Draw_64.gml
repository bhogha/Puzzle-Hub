...
ph_draw_text(PH_W/2, _hud_y, "ARROW", global.fnt_disp_md, ACCENT, fa_center, fa_middle);
...
ph_draw_text(_tp_l+65, _tool_y, _time, global.fnt_pill_num, PH_COL_DARK, fa_left, fa_middle);
