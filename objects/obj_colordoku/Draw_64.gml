...
ph_draw_text(PH_W/2, _hud_y, "DIAMOND", global.fnt_disp_md, ACCENT_DEEP, fa_center, fa_middle);
...
ph_hint_pill_draw(HINT_PILL_L, HINT_PILL_T, HINT_PILL_R, HINT_PILL_B, _chip_sh);   // bounces after 5s idle
...
// ── Post-buy reveal (iris contracts onto the ruled-out cluster) ───────────────
